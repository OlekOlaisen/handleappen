  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (password !== confirmPassword) {
      toast({
        ...
        description: "Vennligst sjekk at passordene er like",
      })
      setIsLoading(false)
      return
    }
    ...
    try {
      ...
      toast({
        ...
        description: "Sjekk innboksen din for en bekreftelseslenke.",
      })
      router.push("/login")
    } catch (error) {
      toast({
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Feil",
        description: "Det oppstod en feil ved pålogging med Google. Prøv igjen senere.",
      })
    } finally {
    ...
    <div className="container flex h-screen w-screen flex-col items-center justify-center">
      ...
      <Card className="w-full max-w-sm">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>Opprett en konto for å komme i gang</CardDescription>
        </CardHeader>
        <CardContent>
